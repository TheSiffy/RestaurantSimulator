  ...
  void drawWaiter() {
    ...
    if (this.servingFood == true) {
      ...
      if (food[this.chefIndex] == "Spaghetti") {
        circle(this.posX + 100, this.posY + 20, 70);
      ...
      square(this.posX + 85, this.posY + 5, 30);
      chefTarget.isFinished = false;
      if (this.target.cusX < this.posX) {
        this.posX -= this.speed;
      }
      else if (this.target.cusX > this.posX) {
        this.posX += this.speed;
      }
      else if (this.target.cusY < this.posY) {
        this.posY -= this.speed;
      }
      else if (this.target.cusY> this.posY) {
        this.posY += this.speed;
    ...
    if (this.wait == 0) {
      ...
      if (this.posX < 800) {
        ...
        if (chance > 2) {
          ...
          square(this.posX + 87, (100 * Waiters.indexOf(this)) + 90, 25);
            }
